  ...
  viewEl.innerHTML = `
    <div class="card entity-toolbar-card mb-3"><div class="card-body">
      <div class="row g-2 align-items-end">
        <div class="col-12 col-md-5"><label class="form-label">Поиск</label><input id="cat_q" class="form-control" value="${esc(filters.q)}"></div>
        ${canWrite ? `<div class="col-12 col-md-3 d-grid"><button id="cat_create" class="btn btn-primary">Создать</button></div>` : `<div class="col-12 col-md-3"></div>`}
      </div>
    </div></div>
